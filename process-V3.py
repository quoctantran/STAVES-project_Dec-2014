	...
	for roots, dirs, files in os.walk(path):
		for file in files: 
			if file.endswith('.png'):
				...
				os.system("./a.out " + filePath + " s > " + pureName + ".txt")
				
				currentPath = "/home/dmosuser/1.10.2/" + pureName + ".txt"
				...
				for line in content: 
					...
					for char in line:
						if char == 's':
							line_bis =  line_bis + ' s, ' + pureName + ',a'
						else:
							line_bis += char
					file_out.writelines(line_bis)
		
				# move the file to results_folder Folder
				os.system("mv " + pureName +".txt /home/dmosuser/1.10.2/results_folder/")
	...
	for line in content:
		...
		if y == '': 
			...
			if os.path.isdir(pathCheck1):
				os.system("mv /home/dmosuser/1.10.2/" + str(t) +".png /home/dmosuser/1.10.2/Reject")
			else: 
		...
		for item in xrange(21):
			...
			if y == z: 
				...
				if os.path.exists(pathChecking2):
					os.system("mv /home/dmosuser/1.10.2/" + str(t) + ".png /home/dmosuser/1.10.2/" + str(y) +"/")
				else:
